...
curl -4sSkL "$url" | $base64_decode | { perl -pe "$gfwlist_txt_perl_script_string"; gfwlist_txt_append_domain_names; } | sort | uniq > /tmp/gfwlist.txt
echo "Download finished."

echo "Writing gfwlist.txt..."
[ -e ./gfwlist.txt ] && mv gfwlist.txt gfwlist.txt.old
mv /tmp/gfwlist.txt ./gfwlist.txt
echo "Finished."
